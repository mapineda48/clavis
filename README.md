...
The same walk in 82 assertions, no browser involved. See [Verification](#verification).
...
- **`verify-api.sh` — 82 assertions that walk the whole permission model from the outside.**
