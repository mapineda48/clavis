...
The same walk in 100 assertions, no browser involved. See [Verification](#verification).
...
- **`verify-api.sh` — 100 assertions that walk the whole permission model from the outside.**
