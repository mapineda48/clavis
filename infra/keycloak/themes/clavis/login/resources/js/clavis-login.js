/* =============================================================================
   Clavis demo login theme — behaviour of the demo user cheat sheet.

   Single responsibility: the `[data-clavis-username]` buttons in the demo user list
...
(function () {
  ...
  var BUTTON_SELECTOR = "[data-clavis-username]";
  ...
  function init() {
    ...
    for (var j = 0; j < buttons.length; j++) {
      (function (button) {
        var username = button.getAttribute("data-clavis-username");
        if (!username) {
