...
require CLAVIS_APP_FQDN CLAVIS_API_FQDN CLAVIS_AUTH_FQDN CLAVIS_ACME_EMAIL CLAVIS_CERT_RESOLVER DEPLOY_SHA \
  ...
  KEYCLOAK_API_CLIENT_SECRET ROOT_EMAIL ROOT_PASSWORD
...
# The API's service-account credential and the root account it seeds at boot.
KEYCLOAK_API_CLIENT_SECRET=${KEYCLOAK_API_CLIENT_SECRET}
ROOT_USERNAME=${ROOT_USERNAME:-root}
ROOT_EMAIL=${ROOT_EMAIL}
ROOT_PASSWORD=${ROOT_PASSWORD}
ROOT_DISPLAY_NAME=${ROOT_DISPLAY_NAME:-Root}
